        ...
        <div className="space-y-10 text-center md:text-left">
          ...
          <div className="space-y-6">
            ...
            <motion.h2
              ...
              className="text-xl md:text-2xl font-medium text-slate-700 dark:text-slate-300 leading-relaxed"
            >
          ...
          >
            <a 
              href="#projects" 
              className="px-8 py-3.5 bg-slate-900 dark:bg-white text-white dark:text-slate-900 rounded-full font-bold transition-all hover:scale-105 active:scale-95 shadow-xl shadow-slate-900/10 dark:shadow-white/5"
            >
              View Projects
            </a>
            <a 
              ...
              className="px-8 py-3.5 bg-white dark:bg-slate-800 text-slate-900 dark:text-white border border-slate-200 dark:border-slate-700 rounded-full font-bold transition-all hover:bg-slate-50 dark:hover:bg-slate-700 hover:scale-105 active:scale-95 shadow-sm"
            >
              GitHub
            </a>
            <a 
              href="#contact" 
              className="px-8 py-3.5 bg-blue-600 text-white rounded-full font-bold transition-all hover:bg-blue-700 hover:shadow-lg hover:shadow-blue-500/20 hover:scale-105 active:scale-95"
            >
              Contact
            </a>
          </motion.div>
